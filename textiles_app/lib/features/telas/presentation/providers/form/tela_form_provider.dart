...
/* class TelaFormNotifier extends StateNotifier<TelaFormState> {
  ...
  Map<String, dynamic> telaToMap() {
    return {
      'id': state.id,
      'nombre': state.nombre,
      'precxmen': state.precxmen,
      'precxmay': state.precxmay,
      'precxrollo': state.precxrollo,
      'precxcompra': state.precxcompra,
    };
  }
...
'',
  ...
  void onPrecxrolloChanged(String) {
    state = state.copyWith(
        '',
        isFormValid: Formz.validate([
'',
...
'',
  ...
  void onPrecxcompraChanged(String) {
    state = state.copyWith(
        '',
        isFormValid: Formz.validate([
'',
